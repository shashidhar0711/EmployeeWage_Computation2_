...
public class Day23EmployeeWageUC11 implements EmployeeWage {

        private List<Company> companies;

        //creating a object list

        public Day23EmployeeWageUC11() {
                companies = new ArrayList<Company>();
        }

        public static void main(String[] args) {
                System.out.println("Starting...");
                final Day23EmployeeWageUC11 empBuilder = new Day23EmployeeWageUC11();
